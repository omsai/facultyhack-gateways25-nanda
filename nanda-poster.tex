...
\begin{multicols}{2}
  ...
  \noindent
    ...
    \begin{tabularx}{\linewidth}{%
      ...
      \bf{Category}
      & \bf{Topic}
      & \bf{This Course} & \bf{ATPESC'24} & \bf{HPC-IC'25}\\
      \midrule
  ...
  \item Trainees are encouraged %
    ...
    \end{itemize}
  \item[HPC Carpentry:] Introduction and workflows
    \begin{itemize}
    \item Supplemental reading for %
      concepts, scaling, and reproducible workflows.
    \end{itemize}
